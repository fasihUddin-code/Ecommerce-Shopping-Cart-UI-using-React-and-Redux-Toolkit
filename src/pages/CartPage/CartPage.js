...
import { removeFromCart, getCartTotal, clearCart, toggleCartQty } from '../../store/slices/cartSlice'
...
const CartPage = () => {
  ...
  const { data: cartProducts, totalItems, totalAmount, deliveryCharges } = useSelector((state) => state.cart);
                    ...
                    <div className='cart-items grid'>
                      {
                        cartProducts.map((cartProduct) => (
                          <div className='cart-item grid' id={cartProduct.id}>
                            <div className='cart-item-img flex flex-column bg-white'>
                              ...
                              >
                                <span className='btn-sqaure-icon'>
                  ...
                  <div className='cart-right bg-white'>
                    <div className='cart-summary text-light-blue'>
                      ...
                      <div className='cart-summary-total flex flex-between fs-18'>
                        ...
                        <span className='fw-6'>
                          {formatPrice(totalAmount + deliveryCharges)}
                        </span>
